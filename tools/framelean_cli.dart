...
class FrameLeanCli {
  ...
  void printUsage({String? commandName}) {
    if (commandName == null) {
      ...
      stdout.writeln('  dart run ../tools/framelean_cli.dart compress --help');
      stdout.writeln('  dart run ../tools/framelean_cli.dart image --help');
      stdout.writeln('  dart run ../tools/framelean_cli.dart audio --help');
      return;
    }
  ...
  void _printCompressUsage() {
    stdout.writeln('用法:');
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart compress <input> [<input2> ...] [options]',
    );
    stdout.writeln('');
    stdout.writeln('选项:');
    ...
    stdout.writeln('示例:');
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart compress ~/Movies/demo.mp4',
    );
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart compress ~/Movies/demo.mp4 '
    ...
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart compress a.mp4 b.mp4 c.mp4 '
      '--codec h265 -r 1080p',
    );
  }
  ...
  void _printImageUsage() {
    stdout.writeln('用法:');
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart image <input> [options]',
    );
    stdout.writeln('');
    stdout.writeln('选项:');
    ...
    stdout.writeln('示例:');
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart image ~/Pictures/photo.png '
  ...
  void _printAudioUsage() {
    stdout.writeln('用法:');
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart audio <input> [options]',
    );
    stdout.writeln('');
    stdout.writeln('选项:');
    stdout.writeln(
    ...
    stdout.writeln('示例:');
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart audio ~/Music/song.wav '
      '--format mp3 --bitrate k320',
    );
    stdout.writeln(
      '  dart run ../tools/framelean_cli.dart audio ~/Music/song.flac '
