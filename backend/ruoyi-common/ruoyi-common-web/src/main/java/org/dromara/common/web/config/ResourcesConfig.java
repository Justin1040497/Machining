...
public class ResourcesConfig implements WebMvcConfigurer {
    ...
    @Value("${framelean.security.allowed-origin-patterns:http://localhost:*,http://127.0.0.1:*}")
    ...
    public CorsFilter corsFilter() {
        ...
        // FrameLean is a single-tenant admin surface; keep browser CORS scoped to configured origins.
