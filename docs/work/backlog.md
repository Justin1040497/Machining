...
| B-004 | FFmpeg 法律材料 | P1 | 待确认 | 发布前再次校验 FFmpeg / x264 / LAME / libwebp / Opus / zimg 许可证材料和源码可得性 | 对照 release 包实际内容更新 `legal/` 和 `docs/reference/` | `docs/reference/ffmpeg-license-distribution.md` |
