...
../THIRD_PARTY_NOTICES.md. Review pubspec.lock and the local package cache
before each public binary release because transitive dependency licenses can
change when packages are upgraded.
