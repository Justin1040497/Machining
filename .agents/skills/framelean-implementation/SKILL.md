...
- Keep `protocol/v1` documentation-only unless an accepted protocol design explicitly authorizes fields, transport, serialization, or generation. Keep Runtime Schema source and baselines in FLL.
