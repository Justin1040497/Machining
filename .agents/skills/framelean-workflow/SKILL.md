...
- Produce a friendly in-app changelog for the current or a specified version and save it to Downloads: `framelean-user-changelog`.
- Create, merge, delete, or refactor project Skills: `framelean-skill-create`.

Only run the full analysis → plan → implementation → validation → delivery chain when the user requests end-to-end execution. Formal release documentation and user changelogs remain separate flows.
