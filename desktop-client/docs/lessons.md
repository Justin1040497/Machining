...
- `tools/windows_updater_helper.dart`
...
- 版本事实：`docs/releases/desktop-client/v1.1.5/workbench-theme-and-reorder.md`
...
- 版本事实：`docs/releases/desktop-client/v1.1.5/media-processing.md`
...
- 版本事实：`docs/releases/desktop-client/v1.2.0/task-completion-sounds.md`
...
- 版本事实：`docs/releases/desktop-client/v1.2.0/media-task-defaults-and-metadata.md`
...
- 版本事实：`docs/releases/desktop-client/v1.1.0/windows-runtime-packaging.md`
...
- 版本事实：`docs/releases/desktop-client/v1.1.5/proprietary-audio-import.md`
...
- 版本事实：`docs/releases/desktop-client/v1.1.0/ffmpeg-command-and-process-control.md`
