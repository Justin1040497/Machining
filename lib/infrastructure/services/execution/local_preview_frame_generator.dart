  ...
  PreviewFrameFingerprint buildFingerprint(
    ...
    return PreviewFrameFingerprint(
      [
        ...
        analysis?.videoCodec,
        analysis?.videoPixelFormat,
        analysis?.videoBitDepth,
        analysis?.colorRange,
        analysis?.colorSpace,
        analysis?.colorTransfer,
        analysis?.colorPrimaries,
        analysis?.averageFrameRate,
        analysis?.realFrameRate,
        analysis?.sampleAspectRatio,
        analysis?.displayAspectRatio,
        analysis?.videoRotationDegrees,
        analysis?.fieldOrder,
        analysis?.preferredBitrate,
        analysis?.audioChannels,
        analysis?.audioSampleRate,
        analysis?.audioChannelLayout,
